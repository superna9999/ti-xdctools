 ...
 * */
/*
 *  ======== ti/targets/elf/arp32/std.h ========
 *  Standard types for supported TI compilers for ARP32
 */

#ifndef ti_targets_elf_arp32_STD_
#define ti_targets_elf_arp32_STD_
...
#endif /* ti_targets_elf_arp32_STD_ */
/*
 *  @(#) ti.targets.arp32.elf; 1, 0, 0,17; 4-27-2012 17:07:38; /db/ztree/library/trees/xdctargets/xdctargets-f21x/src/ xlibrary

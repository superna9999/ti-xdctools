...
public class ti_targets_arp32_elf
{
    ...
    void ARP32$$TYPES()
    {
        ...
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.arp32.elf"), Global.newObject("cmd", "cl-arp32 -c", "opts", "--silicon_version=v210"), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.arp32.elf"), Global.newObject("cmd", "cl-arp32 -c", "opts", "--silicon_version=v210"), "rh");

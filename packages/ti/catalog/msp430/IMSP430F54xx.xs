...
{
//    var Clock = xdc.useModule("ti.catalog.msp430.peripherals.clock.BCSplus");		// TODO: 5xx devices need the UCS clock system
    ...
    var clock;	// = Clock.create(ie1, {name: "clock", baseAddr: 0x160});				// TODO: 5xx devices need the UCS clock system
